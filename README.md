...
1. SDSink に音源ファイルを登録する
    * サンプル
        ...
        ```
    * 音源ファイルはSDカード上に置きます
    * この例では、ノート番号60に AUDIO/C3.wav 、ノート番号62に AUDIO/D3.wav を対応させた、合計12要素の対応表を定義している
2. SDSink を使って音を出す
...
1. YuruhornSrc と SDSink を接続する
    * サンプル
        ...
        const SDSink::Item table[26] = {
            {48, "AUDIO/C2.wav"}, {49, "AUDIO/C#2.wav"},
            {50, "AUDIO/D2.wav"}, {51, "AUDIO/D#2.wav"},
            {52, "AUDIO/E2.wav"},
            {53, "AUDIO/F2.wav"}, {54, "AUDIO/F#2.wav"},
            {55, "AUDIO/G2.wav"}, {56, "AUDIO/G#2.wav"},
            {57, "AUDIO/A2.wav"}, {58, "AUDIO/A#2.wav"},
            {59, "AUDIO/B2.wav"},
            {60, "AUDIO/C3.wav"}, {61, "AUDIO/C#3.wav"},
            {62, "AUDIO/D3.wav"}, {63, "AUDIO/D#3.wav"},
            {64, "AUDIO/E3.wav"},
            {65, "AUDIO/F3.wav"}, {66, "AUDIO/F#3.wav"},
            {67, "AUDIO/G3.wav"}, {68, "AUDIO/G#3.wav"},
            {69, "AUDIO/A3.wav"}, {70, "AUDIO/A#3.wav"},
            {71, "AUDIO/B3.wav"},
            {72, "AUDIO/C4.wav"}, {73, "AUDIO/C#4.wav"}
        };
...
1. 音源ファイルとノート番号の対応を記述する
	* サンプル
    	```CupHorn.sfz
        <region> key=48 sample=CupHorn/C2.wav
        <region> key=49 sample=CupHorn/C#2.wav
        <region> key=50 sample=CupHorn/D2.wav
        ```
        | キーワード                         | 分類     | 説明                                             |
        | ---                                | ---      | ---                                              |
    ...
    * この例では、ノート番号48に CupHorn/C2.wav 、ノート番号50に CupHorn/D2.wav が対応しています。
2. 音源ファイルの再生方法を指定する
    * サンプル
        ```CupHorn.sfz
        <region> key=48 sample=CupHorn/C2.wav  loop_mode=loop_continuous loop_start=149636 loop_end=186316
        <region> key=49 sample=CupHorn/C#2.wav loop_mode=loop_continuous loop_start=148858 loop_end=181748
        <region> key=50 sample=CupHorn/D2.wav  loop_mode=loop_continuous loop_start=150309 loop_end=181352
        ```
        | キーワード                        | 分類     | 説明                                                                       |
        | ---                               | ---      | ---                                                                        |
